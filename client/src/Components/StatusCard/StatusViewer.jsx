  ...
  return (
    <div>
        <div className='relatice flex justify-center items-center h-[100vh] bg-slate-900'>
            ...
            <div>
                <BsArrowLeft onClick={handleNavigate} className='text-white text-2xl cursor-pointer absolute top-3 left-10'/>
                <AiOutlineClose onClick={handleNavigate} className='text-white text-2xl cursor-pointer absolute top-3 right-10'/>
            </div>
        </div>
    </div>
  )
